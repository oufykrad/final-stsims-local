            ...
            <tbody>
                <tr v-for="(list,index) in lists" v-bind:key="index" :class="[(list.is_active == 0) ? 'table-warnings' : '']">
                    ...
                    <td>
                        ...
                        <p class="fs-12 text-muted mb-0">{{list.profileable.name}}</p>
                    </td>
                    ...
                    <td class="text-end">
                        ...
                        <b-button variant="soft-warning"  @click="update('verify',list,index)" v-b-tooltip.hover title="Verify" size="sm" class="remove-list me-1">
                            <i class="ri-mail-send-fill align-bottom"></i>
                        </b-button>
                        <!-- <Link :href="'students/'+list.id">
                            <b-button variant="soft-danger" v-b-tooltip.hover title="View" size="sm" class="remove-list me-1">
