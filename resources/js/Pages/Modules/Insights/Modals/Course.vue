                ...
                <div class="table-responsive">
                    <table class="table align-middle table-centered table-nowrap mb-3">
                        <thead class="text-muted table-light fs-11">
                            <tr>
                                <th style="cursor: pointer;" @click="sort(this.sorty)"><i class='bx bxs-sort-alt' style="font-size: 15px;"></i></th>
...
export default {
    ...
    methods : {
        ...
        fetch(page_url) {
            ...
            axios.get(page_url, {
                params: { type: 'courses', sort: this.sorty, scholar: this.scholar }
            })
            .then(response => {
